  ...
  useEffect(() => {
    ...
    async function fetchLogo() {
      ...
      if (error) {
        ...
        setLogo("/default-logo.png"); // Provide a fallback logo
      } else {
        setLogo(data?.logo || "/default-logo.png"); // Use default logo if empty
      }
    }
    ...
    <>
      ...
      <div className="border-b border-gray-200 flex justify-between items-center py-4 mx-auto max-w-7xl md:hidden">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2">
          <Image
            src={logo || "/default-logo.png"} // Ensure no empty string is passed
            alt="Logo"
